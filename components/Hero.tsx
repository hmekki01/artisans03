      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Trouver un artisan bilingue **Français / Arabe**, de confiance et recommandé devient enfin simple. Découvrez la plateforme qui rassemble le vrai bouche‑à‑oreille local et le partage instantané de contacts. Une nouvelle façon de se connecter à sa communauté. 
