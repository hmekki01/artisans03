  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cleanEmail = email
        .normalize('NFKC') // unicode -> forme canonique
        .trim()            // retire espaces début/fin
        .toLowerCase();    // standardiser

      // 2) Vérif rapide côté client (optionnel)
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-100">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-black text-slate-900">Devenir Artisan</h1>
            <p className="text-slate-500 mt-2">Rejoignez l'annuaire des artisans de confiance de l'Allier.</p>
          </div>
