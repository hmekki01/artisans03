      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-100">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-2">Accédez à votre espace visiteur pour gérer vos informations.</p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 text-center">
            <p className="text-slate-500 text-sm">
              ...
              <Link href="/visitor/inscription" className="text-blue-600 font-bold hover:underline ml-1">
